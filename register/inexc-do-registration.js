    ...
    try {
      if (institutional) {
        const response = await fetch(`${endpoint}/institution-requests`, {
          ...
          body: JSON.stringify({ name: document.getElementById('name').value.trim(), email: document.getElementById('email').value.trim(), phone: document.getElementById('phone').value.trim(), organization: document.getElementById('organization').value.trim(), audienceSize: document.getElementById('audienceSize').value.trim(), requestDetails: document.getElementById('institutionRequest').value.trim(), preferredTiming: document.getElementById('preferredTiming').value.trim() })
        });
