...
(() => {
  ...
  style.textContent = `
    ...
    #assistantPanel{position:absolute;bottom:67px;right:0;width:360px;margin:0;padding:0;overflow:hidden;background:#fff;border:1px solid #d8e9fa;border-radius:18px;box-shadow:0 24px 65px #0753982b;direction:rtl}
